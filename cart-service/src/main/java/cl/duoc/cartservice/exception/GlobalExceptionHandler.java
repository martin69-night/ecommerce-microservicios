...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarItemNoEncontrado(
            CarritoItemNotFoundException ex
    ) {
        logger.warn("evento=item_carrito_no_encontrado mensaje={}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> manejarCarritoVacio(
            CarritoVacioException ex
    ) {
        logger.warn("evento=carrito_vacio mensaje={}", ex.getMessage());
