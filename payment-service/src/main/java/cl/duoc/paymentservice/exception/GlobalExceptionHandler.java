...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarPagoNoEncontrado(PagoNotFoundException ex) {
        logger.warn("evento=pago_no_encontrado mensaje={}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> manejarPagoInvalido(PagoInvalidoException ex) {
        logger.warn("evento=pago_invalido mensaje={}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> manejarErrorValidacion(MethodArgumentNotValidException ex) {
