...
@Tag(name = "API Envio Service", description = "Documentación de envíos")
@RestController
...
public class EnvioController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EnvioResponse> buscarPorId(@Parameter(description = "ID del recurso", required = true) @PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EnvioResponse> actualizar(@Parameter(description = "ID del recurso", required = true) @PathVariable Long id, @Valid @RequestBody EnvioRequest request) {
