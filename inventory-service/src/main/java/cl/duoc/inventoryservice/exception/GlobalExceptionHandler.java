...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarInventarioNoEncontrado(
            InventarioNotFoundException ex
    ) {
        logger.warn("evento=inventario_no_encontrado mensaje={}", ex.getMessage());
    ...
    @ExceptionHandler(SkuInventarioDuplicadoException.class)
    public ResponseEntity<Map<String, Object>> manejarSkuDuplicado(
            SkuInventarioDuplicadoException ex
    ) {
        logger.warn("evento=sku_inventario_duplicado mensaje={}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> manejarStockInsuficiente(
        ...
        logger.warn("evento=stock_insuficiente mensaje={}", ex.getMessage());
