...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarInventarioNoEncontrado(InventarioNotFoundException ex) {
        Map<String, Object> respuesta = new LinkedHashMap<>();
        respuesta.put("timestamp", LocalDateTime.now());
        respuesta.put("status", HttpStatus.NOT_FOUND.value());
        respuesta.put("error", "Inventario no encontrado");
    ...
    public ResponseEntity<Map<String, Object>> manejarSkuDuplicado(SkuInventarioDuplicadoException ex) {
        Map<String, Object> respuesta = new LinkedHashMap<>();
        respuesta.put("timestamp", LocalDateTime.now());
